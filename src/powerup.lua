...
class "StrongArm" (Powerup) {
    name = "strongarm",
    cost = 5,
    hover_text = "Strong Arm \n'Converts' three detractors on a committee into supporters for this turn.",
...
class "Shutdown" (Powerup) {
    name = "shutdown",
    cost = 10,
    hover_text = "Shutdown \nCompletely skips a committee vote for this turn.",
...
class "GoodPublicity" (Powerup) {
    name = "goodpublcty",
    cost = 6,
    hover_text = "Good Publicity \n A media push removes three detractors from a project.",
...
class "Swap" (Powerup) {
    name = "swap",
    cost = "free",
    hover_text = "Swap Order \nSwitches the position of any two committees.",
...
class "Mislabel" (Powerup) {
    name = "mislabel",
    cost = "priceless",
    hover_text = "Mislabel Building Plan \nLets you make a building be evaluated as a different color.",
...
class "Appeal" (Powerup) {
    name = "appeal",
    cost = 3,
    hover_text = "Appeal \nReverts any failures on a project and sends it back to the top.",
...
class "Lackey" (Powerup) {
    name = "lackey",
    cost = 6,
    hover_text = "Lackey \nAdds a 'Moses Man', a longterm supporter, to a committee.",
...
class "Resilience" (Powerup) {
    name = "resilience",
    cost = "priceless",
    hover_text = "Keeps the haters at bay.",
